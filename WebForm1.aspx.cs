...
namespace KartotekaLokatora
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            MailAddress mailAddress = new MailAddress("lukasz.dobrzynski@wp.pl", "Lotników 19A/27");
            MailMessage email = new MailMessage();
            email.To.Add("lukasz.dobrzynski@wp.pl");
            email.To.Add("malgosia_czerwinska@wp.pl");
